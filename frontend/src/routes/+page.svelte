        ...
        <div class="mt-40 px-4 py-10 rounded-lg bg-blue-400 flex flex-col m-4 md:flex-row">
            ...
            <div class="links flex-1 p-4 text-white text-center">
                ...
                <div class="flex justify-center my-8">
                    <a href="/youtube" class="btn mr-2 px-8 bg-black border-1   border-white">Channel ansehen</a>
                    <a href="/youtube" class="btn mr-2 bg-blue-700 px-8 border-1 border-white">Content guide</a>
                  </div>
            </div>
        </div>
    </div>
...
<style>
.wrapper {
    background: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url("/images/programming.jpg") no-repeat center center fixed;
